...
export default function ModalAddPhoto(props) {
    ...
    if(userPhoto[0] === 'client'){
      console.log('client');
       urls = `https://arquitech.deveckor.com/clients/${userPhoto[1]}`
    } else {
      console.log('office');
      urls = `https://arquitech.deveckor.com/offices/${id}`
    }
        console.log(urls);
    async function uploadAvatar(e) {
       ...
       try {
           let res = await fetch(`https://arquitech.deveckor.com/upload/${props.officeData.bucket}`, options)
